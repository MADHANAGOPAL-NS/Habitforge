...
router.get("/dashboard", authMiddleware, async (req, res) => {
    ...
    try {
        ...
        // Final check to sync Premium status
        const syncUser = await User.findById(userIdObj).select('isPremium').lean();
        const isPremiumStatus = syncUser ? syncUser.isPremium : false;
