      ...
      <div className="bg-[#111633] p-10 rounded-xl w-96 text-white flex flex-col items-center glow-card">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
          <div className="flex items-center bg-[#1B2147] p-3 rounded-md focus-within:ring-2 focus-within:ring-purple-500 transition-all duration-200">
            ...
            <input type="email" placeholder="Email" className="bg-transparent w-full focus:outline-none" onChange={(e) => setEmail(e.target.value)} />
          </div>
          
          <div className="flex items-center bg-[#1B2147] p-3 rounded-md focus-within:ring-2 focus-within:ring-purple-500 transition-all duration-200">
            <FaLock className="text-gray-400 mr-3" />
            <input type={showPassword ? "text" : "password"} placeholder="Password" className="bg-transparent w-full focus:outline-none" onChange={(e) => setPassword(e.target.value)} />
